# Graph Report - Hotel u mustku  (2026-08-20)

## Corpus Check
- 55 files · ~178,912 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 776 nodes · 1650 edges · 48 communities (42 shown, 6 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c7419aa1`
...
Cohesion: 0.11
Nodes (39): Zákaz upsertu na room_prices, aktivniSezona(), bindCenikModal(), dialogHtml(), escapuj(), hodnotaKategorie(), hodnotaPokoje(), kartaVolby() (+31 more)
...
Cohesion: 0.17
Nodes (4): AdminDashboard, formatCzechDateStr(), getDiscountValidityDisplay(), deleteStoredNewsItem()
...
## Knowledge Gaps
- **262 isolated node(s):** `POVOLENE_TYPY`, `S`, `CIL_SIRKA`, `CIL_VYSKA`, `POVOLENE_TYPY` (+257 more)
...
- **What connects `POVOLENE_TYPY`, `S`, `CIL_SIRKA` to the rest of the system?**
