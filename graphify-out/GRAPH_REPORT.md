...
Cohesion: 0.05
Nodes (53): Pravidlo — date_to je výlučné, obnovCenik(), AdminDashboard, formatCzechDateStr(), getDiscountValidityDisplay(), ALLOWED_SUPABASE_COLUMNS, decrementDiscountCodeUsage(), DEFAULT_REVIEWS (+45 more)
