...
## Corpus Check
- 65 files · ~233,258 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 852 nodes · 1877 edges · 49 communities (43 shown, 6 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d88e0221`
...
Cohesion: 0.09
Nodes (45): Zákaz upsertu na room_prices, aktivniSezona(), bindCenikModal(), delkaObdobiDni(), denMesicKlic(), dialogHtml(), escapuj(), hodnotaKategorie() (+37 more)
...
Cohesion: 0.06
Nodes (84): Pravidlo — date_to je výlučné, posunDatum(), zobrazRozsahBlokace(), ALLOWED_SUPABASE_COLUMNS, decrementDiscountCodeUsage(), DEFAULT_REVIEWS, deleteStoredBlockedDate(), deleteStoredDiscountCode() (+76 more)
...
## Knowledge Gaps
- **266 isolated node(s):** `/Users/ondrejzeman/.local/bin/graphify-mcp`, `GRAPHIFY_QUERY_LOG_ENABLE`, `zima`, `silvestr`, `cenikSVyjimkou` (+261 more)
...
- **What connects `/Users/ondrejzeman/.local/bin/graphify-mcp`, `GRAPHIFY_QUERY_LOG_ENABLE`, `zima` to the rest of the system?**
