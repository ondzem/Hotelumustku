...
export const MOCK_ROOMS = [
  ...
  { id: 'pa', name: 'Pokoj Nadstandard Mahagon', type: 'nadstandard', floor: 'prizemi', capacity: 2, extraBeds: 1, basePrice: 890, image: '/pokoje/mahagon/1.webp' },
  { id: 'p5', name: 'Pokoj Standard P5', type: 'standard', floor: 'prizemi', capacity: 2, extraBeds: 0, basePrice: 830, image: '/pokoje/p5/1.webp' },
  { id: 'p6', name: 'Pokoj Standard P6', type: 'standard', floor: 'prizemi', capacity: 2, extraBeds: 0, basePrice: 830, image: '/hezky pokoj 1.webp' },
  { id: 'p7', name: 'Pokoj Standard P7', type: 'standard', floor: 'vyhled', capacity: 2, extraBeds: 0, basePrice: 830, image: '/pokoje/p7/1.webp' },
  { id: 'a1', name: 'Pokoj Nadstandard Motýl', type: 'nadstandard', floor: 'vyhled', capacity: 2, extraBeds: 1, basePrice: 890, image: '/pokoje/motyl/1.webp' },
  { id: 'zen', name: 'Pokoj Nadstandard Zen', type: 'nadstandard', floor: 'vyhled', capacity: 2, extraBeds: 0, basePrice: 890, image: '/pokoje/zen/1.webp' },
  { id: 'p10', name: 'Pokoj Standard P10', type: 'standard', floor: 'vyhled', capacity: 2, extraBeds: 0, basePrice: 830, image: '/pokoje/p10/1.webp' },
  { id: 'p11', name: 'Pokoj Standard P11', type: 'standard', floor: 'vyhled', capacity: 2, extraBeds: 0, basePrice: 830, image: '/pokoje/p11/1.webp' },
  { id: 'p12', name: 'Pokoj Standard P12', type: 'standard', floor: 'vyhled', capacity: 2, extraBeds: 0, basePrice: 830, image: '/pokoje/p12/1.webp' },
];
