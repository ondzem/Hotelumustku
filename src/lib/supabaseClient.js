...
export const DEFAULT_REVIEWS = [
  { id: 'rev-hist-1', author_name: 'Jitka', full_name: 'Jitka', rating: 5, date: '26. 06. 2026', text: 'Strávili jsme tady s manželem nádherný víkend. Krásné prostředí, útulný hotel, výborná kuchyně, i když vaří jenom jedno menu. Úschovna kol, kde jsme si mohli elektrokola nabít, a co bylo super v těchto vedrech — pod terasou nádherný splav, kde jsme se mohli koupat. Posezení na zahrádce u dobrého piva bylo super. Určitě ještě přijedeme.', status: 'approved', created_at: '2026-06-26T12:00:00Z' },
  { id: 'rev-hist-2', author_name: 'Lenka a Ruda', full_name: 'Lenka a Ruda', rating: 5, date: '24. 08. 2025', text: 'Děkujeme za příjemně strávenou dovolenou v útulných, velmi čistých pokojích. Majitelé jsou pohodoví a ochotní, velký výběr domácích produktů ve snídaňovém bufetu, večeře výborné za lidové ceny. Určitě doporučujeme všem, kdo stojí o dovolenou v hezkém, klidném prostředí. Stoprocentní spokojenost, vřele doporučujeme. Děkujeme.', status: 'approved', created_at: '2025-08-24T12:00:00Z' },
  { id: 'rev-hist-3', author_name: 'Dana N.', full_name: 'Dana N.', rating: 5, date: '17. 08. 2025', text: 'Byli jsme jen na tři dny, ale naprostá spokojenost. Tak čistý pokoj jsme snad ještě nezažili, majitelé vstřícní a jídlo také nemělo chybu. Pokud pojedeme do těchto končin znovu, určitě se ubytujeme opět tady.', status: 'approved', created_at: '2025-08-17T12:00:00Z' },
  { id: 'rev-hist-4', author_name: 'Roman K.', full_name: 'Roman K.', rating: 5, date: '08. 08. 2025', text: 'Spokojenost, doporučuji.', status: 'approved', created_at: '2025-08-08T12:00:00Z' },
  { id: 'rev-hist-5', author_name: 'Adam', full_name: 'Adam', rating: 5, date: '18. 02. 2025', text: 'Pobyt se nám u vás moc líbil. Milý přístup, krásně čisto, výborné jídlo, pěkné okolí hotelu a večer jsme se nenudili (kulečník, fotbálek, stolní tenis). Děkujeme :-)', status: 'approved', created_at: '2025-02-18T12:00:00Z' },
  { id: 'rev-hist-6', author_name: 'Honza', full_name: 'Honza', rating: 5, date: '02. 02. 2025', text: 'V současné době můžu pochválit ceny, krásně čisto, příjemný personál, klidné místo. Vřele doporučuji.', status: 'approved', created_at: '2025-02-02T12:00:00Z' },
  { id: 'rev-hist-7', author_name: 'Jirka', full_name: 'Jirka', rating: 5, date: '10. 09. 2024', text: 'Pokud chcete dovolenou v klidném prostředí, tak vřele doporučuji. Na hotelu klid, v noci klid a okolí krásné a klidné. Výborné večeře, sice bez výběru, jedno menu, ale kvalita, se kterou se hned tak nesetkáte. Podotýkám česká kuchyně. Rádi se sem vrátíme.', status: 'approved', created_at: '2024-09-10T12:00:00Z' },
  { id: 'rev-hist-8', author_name: 'Tomáš', full_name: 'Tomáš', rating: 5, date: '18. 06. 2024', text: 'Vrátili jsme se po třech letech a můžu říct, že jsem opět mile překvapen. Ceny pořád stejné, výborná kuchyně a pokoje bez sebemenší špíny, prostě super. Díky.', status: 'approved', created_at: '2024-06-18T12:00:00Z' },
  { id: 'rev-hist-9', author_name: 'Zbyněk', full_name: 'Zbyněk', rating: 5, date: '05. 01. 2024', text: 'Super místo, Silvestr neměl chybu. Perfektní jídlo, snídaně — velký výběr. V létě určitě přijedeme. Velice příjemný a ochotný personál. Určitě v létě přijedeme na kola.', status: 'approved', created_at: '2024-01-05T12:00:00Z' },
  { id: 'rev-hist-10', author_name: 'Jana a Zdeněk', full_name: 'Jana a Zdeněk', rating: 5, date: '11. 08. 2023', text: 'Na dovolené jsme zde byli už počtvrté a opět stoprocentní spokojenost. Ochotní majitelé, výborná kuchyně, čisté pokoje a hlavně klid a pohoda. Děkujeme za příjemně strávenou dovolenou. Těšíme se na příště.', status: 'approved', created_at: '2023-08-11T12:00:00Z' },
