      ...
      <div class="terms-modal-overlay" id="terms-modal-overlay" aria-hidden="true">
        <div class="terms-modal-card">
          ...
          <div class="terms-modal-body">
            <!-- Rychlý kontakt na recepci -->
            <div class="terms-contact-bar">
              <span class="contact-bar-title">Rychlý kontakt na recepci pro individuální dohodu:</span>
              <div class="contact-bar-items">
                <a href="tel:+420777666273" class="terms-contact-btn">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                  </svg>
                  <span>+420 777 666 273</span>
                </a>
                <a href="mailto:hotel@umustku.cz" class="terms-contact-btn">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
